...
$txt['oasl_settings_allow_login_new_desc'] = 'If disabled an error is displayed when a new user connects with Social Login on the login page. If enabled a new account is registered automatically.';
