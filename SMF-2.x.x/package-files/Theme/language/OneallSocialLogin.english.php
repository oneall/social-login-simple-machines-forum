...
$txt['oasl_settings_allow_login_new'] = 'Allow the registration of new users through the login page?';
$txt['oasl_settings_allow_login_new_desc'] = 'If this option is disabled, then NEW users may not register with Social Login on the login page; they first need to connect through the registration page.';
$txt['oasl_settings_allow_login_new_yes'] = 'Yes, allow new users to signup with Social Login on the login page too.';

$txt['oasl_settings_reg_method'] = 'Method of registration employed for new members?';
$txt['oasl_settings_reg_method_desc'] = 'Manual approval should not be required as Social Login eliminates SPAM issues almost entirely.';
$txt['oasl_settings_reg_method_auto'] = 'Automatically approve users that register with Social Login ';
$txt['oasl_settings_reg_method_system'] = 'Use the system-wide setting from Administration \ Registration  \ Settings.';
$txt['oasl_settings_reg_method_email'] = 'Use email activation (New users receive an email with an activation link).';
$txt['oasl_settings_reg_method_admin'] = 'Use admin approval (New users have to be approved by an administrator).';
$txt['oasl_settings_reg_method_disable'] = 'Registration of new members is disabled.';
